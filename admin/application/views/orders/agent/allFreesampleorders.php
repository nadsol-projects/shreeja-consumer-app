                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Free Sample Orders</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                           ...
                                           ?> 
                                            ...
                                            <tr> 
                                                ...
                                                <td style="padding: 0.5rem;"><?php echo $u->delivery_date ?></td>
                                                <td style="padding: 0.5rem;" align="center"><?php echo ($u->order_status == "Success") ? '<span class="badge badge-success">Success</span>' : '<span class="badge badge-danger">Failed</span>' ?></td>
                                                ...
                                                <td style="padding: 0.5rem;" align="center">
                                                    <a href="<?php echo base_url() ?>agent-orders/view-free-sample-order/<?php echo $u->order_id ?>" class="text-inverse p-r-10"><i class="fas fa-eye" style="color: black"></i></a>
