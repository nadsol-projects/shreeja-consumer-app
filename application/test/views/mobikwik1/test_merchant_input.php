...
<div class="center">
<div class="ecssing">
<form action="<?php echo base_url("mobikwik/posttozaakpay") ?>" method="post">
...
<tr>	
	...
	<td width="50%" align="center" valign="middle"><input type="text" name="merchantIdentifier" value="b19e8f103bce406cbd3476431b6b7973" /></td>
</tr>
<tr>	
	<td width="50%" align="right" valign="middle">Order Id</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="orderId" value="ORD85748574" name="orderId" /></td>
</tr>
<!-- <tr>
