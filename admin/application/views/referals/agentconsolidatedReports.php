                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Agent Consolidated Reports</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                       ...
                       <div class="row">   
                        ...
                        <div class="card" style="border: 0px">
                            <div class="card-body">
                                ...
                                <div class="table-responsive zero_config1">
...
$("#filter").click(function(){
	...
	var edate = $("#edate").val();
		...
		var table = $('#zero_config1').dataTable({
         "bProcessing": true,
         "ajax": {
			"url": "<?php echo base_url("referals/agentfilterconsolidatedReports") ?>",
			"type": "POST",
