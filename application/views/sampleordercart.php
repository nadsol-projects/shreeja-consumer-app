				  ...
				  if($ord){
					...
					<form method="post" action="<?php echo base_url("cart/insertSampleOrder") ?>">				
						...
						<div class="row">
							...
							<a href="<?php echo base_url("home/profile#nav-sample") ?>" class="btn btn-primary btn-rounded sample-btns col-md-2">Back</a>
							
							
							<input type="submit" class="btn btn-primary btn-rounded sample-btns col-md-2" style="margin-left:10px" value="Confirm">
						</div>
...
<!--						<div class="change"><a href="#" style="color: #007bff" id="changeAddr">CHANGE</a></div>-->
	...
	<?php }}else{ ?>				
				...
				<div class="container more-orders" align="center">
					...
					<li>To view more products to order,Please <a href="<?php echo base_url("products") ?>" style="color:blue">Click Here</a></li>
