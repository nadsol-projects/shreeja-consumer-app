...
<!--                        <h4 class="page-title"><?php //echo $n->name ?> Sub Menu</h4>-->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form action="<?php echo base_url() ?>navbar/navbar_menu/insertSubmenu" method="post">
                               <!--  <div class="card-body">
...
<!--
                                                     <select class="form-control select" name="sub_menu_link" required id="">
                                                        <option value="">Select Sub Menu Link</option>
                                                       <?php 
//															$nl = $this->db->get_where("fdm_va_navbar_header_routes")->result();
//                                                            foreach ($nl as $l) {
                                                        ?>
                                                        <option value="<?php //echo $l->route ?>"><?php //echo $l->name ?></option> 
                                                        <?php //} ?>
                                                     </select>
-->
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    ...
                                                    <select class="form-control" required name="sub_menu_target" id="">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group has-success">
                                                    ...
                                                    <select class="form-control" required name="menu_type" id="">
                                        	...
                                        	<div class="col-md-3">
											 ...
											 <div class="col-md-3">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Meta Keyword" name="meta_keyword" required="">
													</div>
											 </div>
											  ...
											  <div class="col-md-3">
													<div class="form-group">
														...
														<textarea class="form-control" placeholder="Meta Description" name="meta_description" required rows="3"></textarea>
													</div>
											  </div> 
                                        ...
                                        <tbody>
                                           ...
                                           foreach ($smenu as $u) {  ?> 
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 0.5rem;"><?php echo $this->db->get_where("fdm_va_navbar_header_menu",array("id"=>$u->menu_name))->row()->name ?></td>
                                               ...
                                               <div class="switch">
                                                ...
                                                <td style="padding: 0.5rem;">
                                                    <a href="<?php echo base_url() ?>menus/edit-sub-menu/<?php echo $u->id ?>" class="text-inverse p-r-10"><i class="ti-marker-alt"></i></a>
