                        ...
                        <div class="d-flex no-block justify-content align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo base_url() ?>agent-products/myorders">Orders</a>
                                    </li>
...
<!--                    	<i class="fa fa-user"></i>-->
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="post" action="<?php echo base_url() ?>agent-products/editOrder" enctype="multipart/form-data">
                                <div class="card-body">
