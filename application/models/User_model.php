...
class User_model extends CI_Model{
	...
	public function order_status($order_id, $order_status, $tracking_id="", $bank_ref_no=""){
	    ...
	    if($order_status==="Success"){
            ...
            if($order_status == "Aborted"){		
                ...
                $this->session->set_flashdata(array("payment_status"=>'<div class="alert alert-warning alert-dismissible" style="margin-top:15%">Payment in processing.</div>'));
            }
    		$this->db->set($data);
    		$this->db->where("order_id",$odata->order_id);
    		$this->db->update("orders");
