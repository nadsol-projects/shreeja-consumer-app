...
public function check_value_offer_on_this_day(){
	    ...
	    $query = $this->db->query("SELECT * FROM tbl_product_offers WHERE offerType='Amount' AND orderType='$orderType' and status='Active' order by cartValue DESC");
	
	
	    $sOffer = $this->db->query("SELECT * FROM tbl_product_offers WHERE offerType='sameProduct' AND orderType='$orderType' and status='Active'");
	    $cOffer = $this->db->query("SELECT * FROM tbl_product_offers WHERE offerType='crossProduct' AND orderType='$orderType' and status='Active'");
