 <?php $d = get_instance(); 
     $au = $d->db->get_where("fdm_va_auths",array("id"=>$d->session->userdata("admin_id")))->row();
...
<head>
    ...
    <title>
        <?php
            if($d->session->userdata("admin_id")){
                echo $d->admin->get_admin("name"); 
            } 
        ?>
    </title>
    <!-- Custom CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/libs/summernote/dist/summernote-lite.css">
<!--    <link href="<?php echo base_url() ?>assets/gridly/css/jquery.gridly.css">-->
    <link href="<?php echo base_url() ?>assets/libs/@claviska/jquery-minicolors/jquery.minicolors.css" rel="stylesheet" type="text/css">
	<link href='<?php echo base_url() ?>assets/css/dragula.css' rel='stylesheet' type='text/css' />
	<link href='<?php echo base_url() ?>assets/css/example.css' rel='stylesheet' type='text/css' />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" integrity="sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ" crossorigin="anonymous"> 
 ...
 <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <?php if($d->session->userdata("admin_id")){ ?>
                    ...
                    <?php } ?>    
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo base_url() ?>assets/front/assets/images/indicator.png" alt="homepage" class="dark-logo" style="height: 50px; width: 30%">&nbsp;
                            <!-- Light Logo icon -->
                            <img src="<?php echo base_url() ?>assets/front/assets/images/indicator.png" alt="homepage" class="light-logo" style="height: 50px; width: 30%" />
                        </b>
                        <!--End Logo icon -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container p-0">
                                                        <img class="d-block img-fluid" src="<?php echo base_url() ?>assets/images/big/img1.jpg" alt="First slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container p-0">
                                                        <img class="d-block img-fluid" src="<?php echo base_url() ?>assets/images/big/img2.jpg" alt="Second slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container p-0">
                                                        <img class="d-block img-fluid" src="<?php echo base_url() ?>assets/images/big/img3.jpg" alt="Third slide">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <ul class="list-style-none">
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="<?php echo base_url() ?>assets/images/users/2.jpg" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="<?php echo base_url() ?>assets/images/users/3.jpg" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="<?php echo base_url() ?>assets/images/users/4.jpg" alt="user" class="rounded-circle">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <img src="<?php echo base_url(); ?><?php echo ($au->profile_pic) ? $au->profile_pic : 'assets/images/users/1.jpg' ?>" alt="users" class="rounded-circle" width="31">
                        ...
                        <img src="<?php echo base_url(); ?><?php echo ($au->profile_pic) ? $au->profile_pic : 'assets/images/users/1.jpg' ?>" alt="users" class="img-circle" width="60">
                               ...
                               <!-- <a class="dropdown-item" href="javascript:void(0)">
                                ...
                                <div class="p-l-30 p-10">
                                    <a href="<?php echo base_url() ?>admin/profile" class="btn btn-sm btn-success btn-rounded">View Profile</a>
                                </div>
                            </div>
                        </li>
                        <!-- ============================================================== -->
