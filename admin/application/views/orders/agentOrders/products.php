			...
			$search_value = "and product_name like '%$search%'";
				...
				$cid = 0;
					...
					foreach($categories as $cat){
						...
						$products = $this->db->query("select * from tbl_products where status='Active' and deleted=0 and product_category='$cat->id' and assigned_to='agents' and location like '%$adata->city%' $search_value GROUP BY product_id order by product_name asc")->result();
