                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Agents Referal Reports Quantities</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
$("#filter").click(function(){
	...
	var table = $('#zero_config1').dataTable({
         "bProcessing": true,
         "ajax": {
			"url": "<?php echo base_url("referals/getAgentreferalquantityreports") ?>",
			"type": "POST",
