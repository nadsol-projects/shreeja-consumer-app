...
public function index(){
	...
	$data["users"] = $this->db->query("select * from shreeja_users where area_delivery_status='Active' order by userid desc")->result();
	$this->load->view("users/allUsers",$data);
}
	
public function bank_details(){

	$data["users"] = $this->db->query("select * from shreeja_users where account_number!='' order by userid desc")->result();
	$this->load->view("users/bank_details",$data);
}
